...
struct FightCategories {
    static let ageCategories = [
        "benjamins", "minimes", "cadets", "junior", "senior", "master",
    ]
    ...
    static let weightCategories: [String: [String: [String: [String]]]] = [
        "regular": [
            "men": [
                ...
                "minimes": [
                    "-27", "-30", "-33", "-37", "-41", "-45", "-49", "-53",
                    "-57", "+57",
                ],
                "benjamins": [
                    "-21", "-24", "-27", "-30", "-33", "-37", "-39", "-41",
                    "-44", "+44",
                ],
            ],
            "women": [
                ...
                "junior": [
                    "-42", "-44", "-46", "-49", "-52", "-55", "-59", "-63",
                    "-68", "+68",
                ],
                "cadets": [
                    "-29", "-33", "-37", "-41", "-44", "-47", "-51", "-55",
                    "-59", "+59",
                ],
                "minimes": [
                    "-23", "-26", "-29", "-33", "-37", "-41", "-44", "-47",
                    "-51", "+51",
                ],
                "benjamins": [
                    "-17", "-20", "-23", "-26", "-29", "-33", "-37", "-41",
                    "-44", "+44",
                ],
            ],
        ],
    ...
    static func getWeightCategories(
        for ageCategory: String, gender: String, isOlympic: Bool
    ) -> [String] {
