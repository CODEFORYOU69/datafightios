...
struct Event: Codable {
    ...
    init(id: String? = nil, creatorUserId: String, eventName: String, eventType: String, location: String, date: Date, imageURL: String? = nil, fightIds: [String]? = nil, country: String) {
        self.id = id
