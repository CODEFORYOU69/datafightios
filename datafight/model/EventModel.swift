...
enum EventType: String, Codable, CaseIterable {
    ...
    case grandPrix = "Grand Prix"
        ...
        init(id: String? = nil, creatorUserId: String, eventName: String, eventType: EventType, location: String, date: Date, imageURL: String? = nil, fightIds: [String]? = nil, country: String) {
            self.id = id
