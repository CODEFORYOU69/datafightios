...
extension AddRoundViewController {
    ...
    func finalizeAction(_ action: Action) {
        ...
        print("Temps vidéo actuel : \(videoTime)")

        
        // Mettre à jour l'action avec le timestamp de la vidéo
        var updatedAction = action
        updatedAction.videoTimestamp = videoTime
        updatedAction.chronoTimestamp = action.chronoTimestamp  // Chrono saisi par l'utilisateur

        print("Adding action with video timestamp: \(updatedAction.videoTimestamp), chrono timestamp: \(String(describing: updatedAction.chronoTimestamp))")
