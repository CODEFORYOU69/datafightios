        ...
        class OptionsView: UIView, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
            ...
            var options: [String] = [] {
                didSet {
                    ...
                    if options.isEmpty {
                        // Gérer l'affichage lorsque la liste est vide
                    } else {
                        collectionView.isHidden = false
                        validateButton.isHidden = !allowsMultipleSelection
            ...
            @objc private func validateSelection() {
                print("Sélections validées : \(selectedOptions)")
            ...
            func collectionView(_ collectionView: UICollectionView, didDeselectItemAt indexPath: IndexPath) {
                ...
                if let index = selectedOptions.firstIndex(of: deselectedOption) {
                    ...
                    print("Option désélectionnée : \(deselectedOption)")
